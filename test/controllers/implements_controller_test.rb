...
class ImplementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create implement" do
    assert_difference('Implement.count') do
      post implements_url, params: { implement: { implement_feature: @implement.implement_feature } }
    end
  ...
  test "should update implement" do
    patch implement_url(@implement), params: { implement: { implement_feature: @implement.implement_feature } }
